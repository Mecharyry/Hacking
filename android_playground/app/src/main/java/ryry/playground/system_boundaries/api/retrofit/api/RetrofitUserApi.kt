...
import ryry.playground.system_boundaries.api.retrofit.internal.RetrofitUsersApi

class RetrofitUserApi(retrofit: Retrofit) : UserApi {

    private val userApi = retrofit.create(ryry.playground.system_boundaries.api.retrofit.internal.RetrofitUsersApi::class.java)
